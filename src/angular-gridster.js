...
(function (root, factory) {
	...
	return angular.module('gridster', [])
		...
		.constant('gridsterConfig', {
			...
			rowHeight: 'fit', // height of grid rows. 'fit' will use scale of parent height and max row, 'match' will make it the same as the column width, a numeric value will be interpreted as pixels, '/2' is half the column width, '*5' is five times the column width, etc.
			...
			minColumns: 2, // minimum amount of columns the grid can scale down to
